...
/// Seeds default stocks/warehouses for fresh installs
...
/// Seeds default customers and partner classifications
...
/// Seeds standard chart of accounts according to double-entry accounting rules
...
/// Seeds core account connections for automatic ledger posting
Future<void> seedDefaultAccountConnects(Database db) async {
  ...
  final defaultConnections = [
    {'type': 0, 'cId': 1110, 'name': 'البنوك'},
    {'type': 1, 'cId': 1110, 'name': 'الصناديق'},
    {'type': 2, 'cId': 1120, 'name': 'العملاء'},
    {'type': 3, 'cId': 2110, 'name': 'الموردون'},
    {'type': 4, 'cId': 2140, 'name': 'الضرائب'},
    {'type': 5, 'cId': 1130, 'name': 'المخزون'},
    {'type': 6, 'cId': 1130, 'name': 'البضاعة'},
    {'type': 7, 'cId': 4110, 'name': 'المبيعات'},
    {'type': 8, 'cId': 3150, 'name': 'الخصم المسموح به'},
    {'type': 9, 'cId': 4140, 'name': 'الخصم المكتسب'},
    {'type': 10, 'cId': 3110, 'name': 'المشتريات'},
  ];
...
Future<void> _seedExpenses(Database db) async {
  ...
  // تكلفة البضاعة المباعة - expense type 4 (alternate c_id: 3160)
  await db.insert('accounts', {
    'c_id': 3160,
    'code': '3009',
    'name': 'تكلفة البضاعة المباعة',
...
/// Seeds default fiscal period for current calendar year
