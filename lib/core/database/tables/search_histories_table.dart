...
class SearchHistoriesTable implements TableSchema {
  @override
  ...
  String get createTable => '''
    CREATE TABLE search_histories (
      ...
      is_pin INTEGER NOT NULL DEFAULT 0 CHECK (is_pin IN (0, 1)),
      search_type INTEGER NOT NULL DEFAULT 0,
  ...
  List<String> get indexes => [
    'CREATE INDEX idx_search_history_query ON search_histories(search_query);',
  ];
}
