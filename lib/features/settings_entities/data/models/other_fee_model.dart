...
class OtherFeeModel extends OtherFeeEntity {
  const OtherFeeModel({
    super.id,
    required super.name,
    super.isActive,
  ...
  factory OtherFeeModel.fromEntity(OtherFeeEntity entity) {
  ...
  factory OtherFeeModel.fromMap(Map<String, dynamic> map) {
    return OtherFeeModel(
      id: map['id'] as int?,
      name: map['name'] as String,
      isActive: (map['is_active'] as int?) == 1,
      accountId: map['account_id'] as int?,
      toolType: map['tool_type'] as int? ?? 0,
